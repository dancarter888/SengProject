...
public class GameScreen {
	...
	public void crewStatus() {
		...
		JOptionPane.showMessageDialog(frmGameScreen, membersString, "Ship Status",
		        						JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public void setCrewLabels() {
		...
		switch(crewSize) {
			case 2:
				...
				lblCrew_2.setText("");
				frmGameScreen.remove(select_2);
				lblCrew_3.setText("");
				frmGameScreen.remove(select_3);
				break;
			case 3:
				lblCrew.setText(String.format("%s: %s (%d/2)", members.get(0).getName(), members.get(0).getClassType(), members.get(0).getActionsRemaining()));
				lblCrew_1.setText(String.format("%s: %s (%d/2)", members.get(1).getName(), members.get(1).getClassType(), members.get(1).getActionsRemaining()));
	...
	private void initialize() {
		...
		btnQuit.setBounds(808, 461, 89, 23);
		...
		btnUseItem.setBounds(499, 223, 115, 42);
		...
		btnSelect.setBounds(192, 172, 89, 23);
		btnSelect.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectCrewMember(0);;
			}
		});
		frmGameScreen.getContentPane().add(btnSelect);
		
		select_1 = new JButton("Select");
		select_1.setBackground(Color.LIGHT_GRAY);
		select_1.setBounds(192, 242, 89, 23);
		select_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectCrewMember(1);;
			}
		});
		frmGameScreen.getContentPane().add(select_1);
		
		select_2 = new JButton("Select");
		select_2.setBackground(Color.LIGHT_GRAY);
		select_2.setBounds(192, 312, 89, 23);
		select_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectCrewMember(2);;
			}
		});
		frmGameScreen.getContentPane().add(select_2);
		
		select_3 = new JButton("Select");
		select_3.setBackground(Color.LIGHT_GRAY);
		select_3.setBounds(192, 382, 89, 23);
		select_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				selectCrewMember(3);;
			}
		});
		frmGameScreen.getContentPane().add(select_3);
