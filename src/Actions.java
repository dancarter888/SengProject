...
public class Actions {
    ...
    public static void sleep(Crew crew) {
        CrewMember member = chooseCrewMember(crew);
        member.sleep();
    }

    public static void repairShip(Crew crew) {
        CrewMember member  = chooseCrewMember(crew);
        crew.getTheShip().repairShields(member);
    }

    public static void searchPlanet(Crew crew) {
        CrewMember member  = chooseCrewMember(crew);
        crew.getTheShip().searchThePlanet(crew, member);
    }

    public static void useItem(Crew crew) {
        CrewMember member = chooseCrewMember(crew);
        crew.useItem(member);
    }
