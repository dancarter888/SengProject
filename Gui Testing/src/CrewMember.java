...
public class CrewMember {
    ...
    public CrewMember(int health, String searchingSkill, String name) {
        this.health = health;
...
//    }
    ...
    public void setName(String newName) {
        ...
        this.name = newName;//scanner.nextLine();
    }
    ...
    public void spacePlagueDamage() {
        this.health -= 20;
        System.out.println(String.format("%s is sick and lost 20 health\n%s now has %d health", name, name, health));
    }
