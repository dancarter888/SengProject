...
public class GameEnvironment {
    ...
    private void dealSpacePlagueDamage() {
        ...
        this.crew.updateCrewWithSpacePlague();
    ...
    public void spacePlague() {
        Random rand = new Random();
        int numToInfect = rand.nextInt(this.numberOfCrew+1);
        ...
        for(int i=0; i<numToInfect; i++) {
            ...
            if(!(this.crew.getCrewWithSpacePlague().contains(memberInfected))) {
                memberInfected.setHasPlague(true);
                this.crew.addCrewWithSpacePlague(memberInfected);
