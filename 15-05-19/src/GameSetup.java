...
public class GameSetup {
	...
	public void setCrewName() {
		...
		if (txtSetCrewName.getText().equals("")) {
	...
	private void initialize() {
		...
		btnContinue.setBounds(376, 227, 89, 23);
		...
		lblShipName.setBounds(10, 155, 125, 14);
		frmSetup.getContentPane().add(lblShipName);
		
		txtMyShip = new JTextField();
		txtMyShip.setBounds(134, 154, 206, 20);
		...
		btnSetShipName.setBounds(350, 151, 115, 23);
